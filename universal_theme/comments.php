...
function universal_theme_comment( $comment, $args, $depth ) {
  ...
  <div class="comment-author-avatar">
    ...
    <div class="comment-reply">
      <svg width="14" height="14" class="icon comments-add-icon" fill="#BCBFC2">
  ...
  <div id="comments" class="comments-area">
    ...
    if ( have_comments() ) :
      ...
      <div class="comments-header">
        ...
        <a href="#" class="comments-add-button">
          <svg width="18" height="18" class="icon comments-add-icon" fill="#BCBFC2">
      ...
      if ( ! comments_open() ) :
        ?>
        <p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'universal_example' ); ?></p>
        <?php
      endif;
    ...
    comment_form(array(
      'comment_field' => '<div class="comment-form-comment">
        <label class="comment-label" for="comment">' . _x( 'What do you think about it?', 'noun' ) . '</label>
